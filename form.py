...
demo = gr.Interface(
    fn=greet,
    inputs=[gr.Dropdown(pairs,multiselect=True,filterable=True,label="Select Permissions")],
    outputs=["text"],
)
